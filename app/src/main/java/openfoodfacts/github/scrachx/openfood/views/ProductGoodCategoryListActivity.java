...
public class ProductGoodCategoryListActivity extends BaseActivity {
    ...
    /**
     * Start a new {@link ProductGoodCategoryListActivity} given a search information
     *
    ...
    private static void startActivity(Context context, SearchInfo searchInfo) {
        Intent intent = new Intent(context, ProductGoodCategoryListActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (scanOnShake) {
            mShakeDetector.setOnShakeListener(count -> Utils.scan(ProductGoodCategoryListActivity.this));
        }
    ...
    protected void newSearchQuery() {
        ...
        apiClient = new OpenFoodAPIClient(ProductGoodCategoryListActivity.this, BuildConfig.OFWEBSITE);
        api = new OpenFoodAPIClient(ProductGoodCategoryListActivity.this);
    ...
    public void getDataFromAPI() {
        ...
        switch (mSearchInfo.getSearchType()) {
            ...
            case SearchType.PACKAGING:
                ...
                break;
            case SearchType.SEARCH:
                api.searchProduct(searchQuery, pageAddress, ProductGoodCategoryListActivity.this, (isOk, searchResponse, countProducts) -> {
                    /*
    ...
    private void setUpRecyclerView() {
        ...
        if (!setupDone) {
            ...
            LinearLayoutManager mLayoutManager = new LinearLayoutManager(ProductGoodCategoryListActivity.this, LinearLayoutManager.VERTICAL, false);
            ...
            productsRecyclerView.addOnItemTouchListener(
                    new RecyclerItemClickListener(ProductGoodCategoryListActivity.this, (view, position) -> {
                        Product p = ((ProductsRecyclerViewAdapter) productsRecyclerView.getAdapter()).getProduct(position);
                        if (p != null) {
                            String barcode = p.getCode();
                            if (Utils.isNetworkConnected(ProductGoodCategoryListActivity.this)) {
                                api.getProduct(barcode, ProductGoodCategoryListActivity.this);
                                try {
                                    View view1 = ProductGoodCategoryListActivity.this.getCurrentFocus();
                                    if (view != null) {
                                        InputMethodManager imm = (InputMethodManager) ProductGoodCategoryListActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
                                ...
                                new MaterialDialog.Builder(ProductGoodCategoryListActivity.this)
                                        ...
                                        .onPositive((dialog, which) -> {
                                            if (Utils.isNetworkConnected(ProductGoodCategoryListActivity.this))
                                                ...
                                                Toast.makeText(ProductGoodCategoryListActivity.this, R.string.device_offline_dialog_title, Toast.LENGTH_SHORT).show();
                                        })
                                        .show();
                            }
                        }
